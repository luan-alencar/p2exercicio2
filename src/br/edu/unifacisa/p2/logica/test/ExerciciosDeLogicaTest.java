...
class ExerciciosDeLogicaTest {
	...
	void testisCPF() {
		/*
		 * Um CPF v�lido tem: - 9 n�meros separados por . - 2 d�gitos verificadores
		 */
		assertTrue(ExerciciosDeLogica.isCPF("443.344.420-05"));// , ExerciciosDeLogica.imprimeCPF("443.344.420-05"));
